...
static void test_score(void) {
  ...
  /* 全部无效 → 无法评分 */
  r.bmi_x100 = HS_VALUE_INVALID;
  r.bodyfat_x10 = HS_VALUE_INVALID;
  r.heart_rate_bpm = HS_VALUE_INVALID;
  r.spo2_x10 = HS_VALUE_INVALID;
  r.balance_x10 = HS_VALUE_INVALID;
  r.reaction_ms = HS_VALUE_INVALID;
