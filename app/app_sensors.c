...
const hs_sensor_t g_hs_registry[] = {
    ...
    { HS_ITEM_WEIGHT,   "weight",   "查樊听",         hx711_weight_init, hx711_weight_measure },
    { HS_ITEM_HR_SPO2,  "hr_spo2",  "王宇浩（组长）", max30102_init,     max30102_measure     },
    { HS_ITEM_BALANCE,  "balance",  "刘晏铭",         mpu6050_init,      mpu6050_measure      },
    { HS_ITEM_GRIP,     "grip",     "王宇浩（组长）", hx711_grip_init,   hx711_grip_measure   },
...
const char *hs_status_str(hs_status_t s)
{
    switch (s) {
        ...
        case HS_NOT_READY:       return "NOT_READY";
        case HS_UNSTABLE:        return "UNSTABLE";
        case HS_TIMEOUT:         return "TIMEOUT";
        case HS_NOT_IMPLEMENTED: return "NOT_IMPLEMENTED";
